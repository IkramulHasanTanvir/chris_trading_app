...
/// Service layer that handles business logic for the home_demo feature.
///
...
class HomeService {
  ...
  /// Fetches all home_demo screen data in parallel.
  ///
  ...
  /// Retrieves all cached home_demo screen data.
  ///
...
/// Data transfer object that holds all home_demo screen data.
///
/// This class aggregates all the data needed for the home_demo screen in a single object,
...
class HomeData {
  ...
  /// Creates a [HomeData] object with all home_demo screen data.
  HomeData({
